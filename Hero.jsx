...
const Hero = () => {
  return (
    ...
    bg-center h-screen'>
        ...
        font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Getway Destination</h1>
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the world's most exclusive Hotels
            and resort. start your journey today.
        </p>
       <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>

            <div>
                <div className='flex items-center gap-2'>
                    <img src={assets.closeIcon} alt="" className='h-4' />
