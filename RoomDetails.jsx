...
const RoomDetails = () => {
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        {/* Room Highlights */}
        <div className='flex flex-col md:flex-row md:justify-betwwen mt-10'>
        ...
        <form className='flex flex-col md:flex-row items-start md:item-center
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Guest will be allocated on the ground floor according to availability.
                You get a comfortable Two bedroom apertment has a true city feelling. The
                price quoted is for Two guest, at the guest slot please mark the number of
                guest to get the exact price for groups. The Guests will be allocatedground floor according to availability.
                You get the comfortable two bedroom
                apartment that has a true city feelling. </p>
