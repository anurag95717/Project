...
const AllRooms = () => {
  ...
  return (
    <div className='flex fex-col-reverse lg:flex-row items-start
      justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24
      xl;px-32'>
    <div>
        <div className='flex flex-col items-start text-left'>
            <h1 className='font-playfair text-4xl md:text-[40px]'>Hotel Rooms</h1>
            <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take advantge of our limeted-time offer and special package to 
        ...
        max-lg:mb-8 min-lg:mt-16'>
            ...
            min-lg:border-b border-gray-300 ${openFilters && 'border-b'}`}>
                ...
                <div className='text-xs cursor-pointer'>
                    <span onClick ={()=>setOpenFilters()}className='lg:hidden'>
                        {openFilters ? 'HIDE' : 'SHOW'}</span>
                    <span className='hidden lg:block'>CLEAR</span>
                </div>
                </div>
                <div className={`${openFilters ? 'h-auto' : 'h-0 lg:h-auto'} oeverflow-hidden transition-all duration-700`}>
